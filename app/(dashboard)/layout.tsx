  ...
  return (
    <aside className="fixed inset-y-0 left-0 z-10 hidden w-14 flex-col border-r bg-background sm:flex">
      <nav className="flex flex-col items-center gap-4 px-2 sm:py-5">
        ...
        >
          <Clock className="h-4 w-4 transition-all group-hover:scale-110" />
          <span className="sr-only">Days Since</span>
        </Link>
  ...
  return (
    <Sheet>
      <SheetTrigger asChild>
        <Button size="icon" variant="outline" className="sm:hidden h-11 min-w-[44px] focus-visible:ring-2">
  ...
  return (
    <Breadcrumb className="hidden md:flex">
      <BreadcrumbList>
        ...
        <BreadcrumbSeparator />
        <BreadcrumbItem>
          <BreadcrumbPage>Days Since</BreadcrumbPage>
        </BreadcrumbItem>
      </BreadcrumbList>
    </Breadcrumb>
  );
